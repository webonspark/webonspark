    ...
    <>
      ...
      <section className="section">
        <Container className="post-body" style={{ maxWidth: 820 }}>
          ...
          <p>Form submissions are delivered to our business email and stored in a private spreadsheet accessible only to authorised team members. The client sign-in on this website remembers your name in your own browser for up to 7 days; you can log out at any time to remove it.</p>
          <h2>Your choices</h2>
