  ...
  return (
    <>
      <Seo
        ...
        description="Visit or contact WebOnspark Technologies at BTM Layout 2nd Stage, Bengaluru 560076. Email WebOnspark@gmail.com or WhatsApp +91 86081 45177 for a free quote."
        path="/contact"
      ...
      <section className="section">
        <Container>
          <Row className="g-4 mb-5">
            <Col md={6} lg={3}>
              <a className="contact-tile" href={whatsappLink()} target="_blank" rel="noopener noreferrer">
                <span className="ct-icon wa"><WhatsAppIcon size={24} /></span>
                <strong>WhatsApp</strong><span>{COMPANY.phoneDisplay}</span>
              </a>
            </Col>
            <Col md={6} lg={3}>
              <a className="contact-tile" href={`tel:+${COMPANY.phoneRaw}`}>
                <span className="ct-icon"><Icon name="phone" /></span>
                <strong>Call us</strong><span>{COMPANY.phoneDisplay}</span>
              </a>
            </Col>
            <Col md={6} lg={3}>
            ...
            <Col md={6} lg={3}>
              <div className="contact-tile">
                ...
                <strong>Working hours</strong><span>{COMPANY.hours}</span>
              </div>
            </Col>
          </Row>
